...
import org.scoverage.coveralls.{CoverallHttpResponse, HttpClient}
...
case class FakeTestHttpClient(status: Int, body: String) extends HttpClient {
  def multipart(url: String, name: String, filename: String, mime: String, data: Array[Byte]) = {
